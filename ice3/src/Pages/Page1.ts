...
class Page1 extends BasePage {
	...
	public constructor() {
        ...
        egret.Tween.get(this.img_3).wait(2000).to({ "alpha": 1 },1500).to({ "alpha": 0 },1500);
        egret.Tween.get(this.img_4).wait(3500).to({ "alpha": 1 },1500).to({ "alpha": 0 },1500);
        egret.Tween.get(this.img_5).wait(5000).to({ "alpha": 1 },1500).call(this.onclick_touch0,this);
